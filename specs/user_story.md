...
- **FR-7: Scenario and Data Management**: Allow users to create, edit, and delete scenarios. Allow users to save and load scenarios. You should update the data of visuazling graph, without deleting the original data.
